...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onSaveInstanceState(Bundle savedInstanceState) {
        ...
        if (rememberMe.isChecked()) {
            ...
            savedInstanceState.putBoolean(Constants.USERNAME_EDIT_TEXT, rememberMe.isChecked());
        }
    }
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        if (savedInstanceState.containsKey(Constants.REMEMBER_ME_CHECKBOX)) {
            ...
            remember_me.setChecked(savedInstanceState.getBoolean(Constants.REMEMBER_ME_CHECKBOX));
        }
    }
